    ...
    public class Program2
    {
        public void Main(string[] args)
        {
            ...
            try
            {
                ...
                Encrypt(xmlDoc, "creditcard", tripleDesCryptoServiceProvider);
                XmlNode docNode = xmlDoc.CreateXmlDeclaration("1.0", "UTF-8", null);
                xmlDoc.InsertBefore(docNode, xmlDoc.FirstChild);
                ...
                Decrypt(xmlDoc, tripleDesCryptoServiceProvider);
                xmlDoc.Save("test-decrypted.xml");
                // Display the encrypted XML to the console.
                Console.WriteLine();
